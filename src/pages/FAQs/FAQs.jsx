	...
	return (
		<div className='accordions-container-FAQs'>
			...
			>
				...
				<AccordionDetails>
					<Typography>
						El objetivo principal de esta aplicación es principalmente enfocarse
						en las personas que tienen un nivel medio y que quieran refrescar
						sus conocimientos o repasar alguna duda en un lapso de tiempo muy
						corto.
					</Typography>
				</AccordionDetails>
			</Accordion>
			...
			>
				...
				<AccordionDetails>
					<Typography>
						...
						alguien que en el pasado sí tenía conocimientos sobre la gramática,
						pero el paso del tiempo sin práctica ha hecho que olvides algunos
						conceptos y el idioma se te vuelve otra vez confuso.
					</Typography>
					<Typography mt={1}>
						Con un repaso del contenido y un examen corto podrás averiguar donde
						estaban tus fallos.
					</Typography>
				</AccordionDetails>
			</Accordion>
			...
			>
				...
				<AccordionDetails>
					<Typography>
						El perfil de usuario es uno los próximos objetivos de Learn English.
					</Typography>
					<Typography mt={1}>
