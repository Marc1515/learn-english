		...
		<>
			...
			<div className='section1-home'>
				...
				<Typography variant='subtitle2' className='text-grammar-3'>
					Ofrecemos una variedad de exámenes que duran aproximadamente 1 minuto
					para aprender y refrescar tus conocimientos, diseñados para ayudarte a
					mejorar tu vocabulario y gramática.
				</Typography>
			</div>
			{/* HomePage Section 2 */}
		</>
